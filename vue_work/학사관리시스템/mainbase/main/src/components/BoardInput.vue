...
<form action="">
   <div ><label for=""><input class="border-2" v-model="title" type="text" name="" id="" placeholder="제목기입"></label>
<select class="border-2" v-model="selectstate" name="" id="">
   ...
   <div ><textarea v-model="content" name="" id="" cols="30" rows="10" placeholder="내용기입" class="border-2 width: 500px height: 200px resize-none"></textarea></div> 
   </form>
...
// axios.post(`http://localhost:8080/freeboard/insert`, data)
// .then((res) => {
//     console.log("인설트 포스트")
//     alert('요청이 접수되었습니다.')
//     router.push({name:'home'})
