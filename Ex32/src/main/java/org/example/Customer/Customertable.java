...
public class Customertable {
    ...
    public void insert(){
        ...
        try {
            ...
            pstmt = conn.prepareStatement("INSERT INTO Customer (c_name, c_phone,c_state,join_date) VALUES (?,?,?,?)");
    ...
    public void update(){
        ...
        try{
            ...
            conn =  DriverManager.getConnection(
                    ...
                    "1234");
            //sql 생성
            pstmt = conn.prepareStatement("UPDATE Customer SET c_name=?, c_phone=?,c_state=?, join_date=?, withdraw_date=? WHERE c_id=?");
            ...
            int c_state = Integer.parseInt(JOptionPane.showInputDialog("1 = 가입중 , 2 = 탈퇴 "));
            pstmt.setInt(3,c_state);
