...
public class gamemake {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int a1 = scan.nextInt();
            if(a1>3 || a1==0){System.out.println(" ===== 1 ~ 3 까지만 ===== ");return;}

            System.out.println("두번째");
            int a2 = scan.nextInt();
            if(a2>3 || a2==0){System.out.println(" ===== 1 ~ 3 까지만 ===== ");return;}

            System.out.println("세번째");
            int a3 = scan.nextInt();
            if(a3>3 || a3==0){System.out.println(" ===== 1 ~ 3 까지만 ===== ");return;}

            System.out.println("네번째");
            int a4 = scan.nextInt();
            if(a4>3 || a4==0){System.out.println(" ===== 1 ~ 3 까지만 ===== ");return;}

            System.out.println("다섯번째");
            int a5 = scan.nextInt();
            if(a5>3 || a5==0){System.out.println(" ===== 1 ~ 3 까지만 ===== ");return;}
